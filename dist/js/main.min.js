...
(function () { const a = document.documentElement; if (a.classList.remove('no-js'), a.classList.add('js'), document.body.classList.contains('has-animations')) { const b = window.sr = ScrollReveal(); b.reveal('.feature, .testimonial', { duration: 600, distance: '50px', easing: 'cubic-bezier(0.5, -0.01, 0, 1.005)', origin: 'bottom', interval: 100 }) } })();